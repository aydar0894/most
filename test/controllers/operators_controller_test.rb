...
class OperatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operator" do
    assert_difference('Operator.count') do
      post operators_url, params: { operator: { first_name: @operator.first_name, last_name: @operator.last_name, middle_name: @operator.middle_name, user_id: @operator.user_id } }
    end
  ...
  test "should update operator" do
    patch operator_url(@operator), params: { operator: { first_name: @operator.first_name, last_name: @operator.last_name, middle_name: @operator.middle_name, user_id: @operator.user_id } }
